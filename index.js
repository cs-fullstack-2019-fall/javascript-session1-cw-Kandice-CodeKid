...
// function main()
// {
//     myArray.forEach(function (EachName)
//         {
...
// document.getElementById("classwork").innerHTML = fbNames;

let newString =<h1 style='color:blue;background:red;text-shadow: -2px 2px 2px #000000;'>[fbNames]</h1>
